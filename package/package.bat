...
adt -package -storetype pkcs12 -keystore cert.p12 -storepass ****** -target ane "com.gerantech.extensions.playpass.ane" extension.xml -swc playpass_as3_lib.swc -platform Android-ARM -platformoptions platform.xml -C android . -platform Android-ARM64 -platformoptions platform.xml -C android . -platform Android-x86 -platformoptions platform.xml -C android . -platform default -C default . && echo f | xcopy /f /y com.gerantech.extensions.playpass.ane ..\playpass_test\exts\